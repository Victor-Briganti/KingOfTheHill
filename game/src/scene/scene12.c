...
#define PLAYER_SCENE12_X_POS (6)  /* In Tile */
#define PLAYER_SCENE12_Y_POS (14) /* In Tile */
...
Scene scene12 = {SCENE12_init, SCENE12_update, SCENE12_hit, SCENE12_destroy};
...
static inline void initGlobals() {
  mapLevelHeight = MAP_SCENE12_HEIGHT;
  mapLevelWidth = MAP_SCENE12_WIDTH;

  mapLevelX = MAP_SCENE12_X_POS;
  mapLevelY = MAP_SCENE12_Y_POS;

  playerInitX = PLAYER_SCENE12_X_POS;
  playerInitY = PLAYER_SCENE12_Y_POS;
}

static inline void initTransition() {
  VDP_init();
  BACKGROUND_initTransition(&level4_3_transition);
...
static inline void updateBackground() {
  BACKGROUND_setText("LEVEL 4-3", LEVEL_TEXT_X, LEVEL_TEXT_Y);
